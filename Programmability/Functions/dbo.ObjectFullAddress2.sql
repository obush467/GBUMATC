...
set  @AddressCursor=cursor
	...
	WITH child_to_parents AS (
	  SELECT FORMALNAME,SHORTNAME,AOGUID,PARENTGUID,AOLEVEL,streetCODE FROM fias.Object
		  WHERE aoGUid = @AOGUID
		  and @gdate between STARTDATE and ENDDATE
	  UNION ALL
	  SELECT o1.FORMALNAME,o1.SHORTNAME,o1.AOGUID,o1.PARENTGUID,o1.AOLEVEL,o1.streetCODE FROM fias.Object o1, child_to_parents
