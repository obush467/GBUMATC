...
set  @AddressCursor=cursor
	...
	WITH child_to_parents AS (
	  SELECT FORMALNAME,SHORTNAME,AOGUID,AOID,PARENTGUID,AOLEVEL FROM fias.Object
		  WHERE aoid = @AOID
	  UNION ALL
	  SELECT o1.FORMALNAME,o1.SHORTNAME,o1.AOGUID,o1.AOID,o1.PARENTGUID,o1.AOLEVEL FROM fias.Object o1, child_to_parents
