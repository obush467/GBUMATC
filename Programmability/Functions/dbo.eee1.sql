...
returns @Tbl TABLE (Ulitsa  nvarchar(200),dom nvarchar(200),korpus nvarchar(200),stroenie nvarchar(200),domFull nvarchar(200),domShort nvarchar(200),dom_korp_str1 nvarchar(200),houseguid uniqueidentifier)  
as 
begin
