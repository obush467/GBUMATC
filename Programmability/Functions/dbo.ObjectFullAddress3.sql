...
set @gdate=GETDATE()
select @AOGUID=AOGUID,@house=[dbo].[dom_korp_str_toStringSplit] (HOUSENUM,BUILDNUM, STRUCNUM,es.NAME,ss.NAME,@NameFull,@Splitter)
from fias.House h
...
set  @AddressCursor=cursor
	...
	WITH child_to_parents AS (
	  SELECT convertstreet,SHORTNAME,AOGUID,PARENTGUID,AOLEVEL,streetCODE FROM fias.Object
		  WHERE aoGUid = @AOGUID
		  and @gdate between STARTDATE and ENDDATE and ACTSTATUS = 1
	  UNION ALL
	  SELECT o1.convertstreet,o1.SHORTNAME,o1.AOGUID,o1.PARENTGUID,o1.AOLEVEL,o1.streetCODE FROM fias.Object o1, child_to_parents
