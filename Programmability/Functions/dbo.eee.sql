...
returns @Tbl TABLE (aoguid uniqueidentifier, parentguid uniqueidentifier, OFFNAME nvarchar(200), FORMALNAME nvarchar(200),SOCRNAME nvarchar(200),SCNAME  nvarchar(200))  
as
begin
WITH o
 AS (
