...
from 
	...
	inner join Raion r on r.ID=a.AdminArea_ID
	...
	inner join DU_to_insert D 
		on (d.Округ=Okrug.shortName or d.Округ=Okrug.fullName)
		and REPLACE(d.Район,'ё','е')=REPLACE(r.shortName,'ё','е') 
